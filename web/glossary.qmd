...
Likelihood
: The _data distribution_! In non-Bayesian statistics, we call this a likelihood but we mean the stochastic machine that generates the data given some parameters. For the globe-tossing model, the data distribution is $W \sim  Binomial(N,p)$
